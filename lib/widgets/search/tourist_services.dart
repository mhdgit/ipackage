...
class _TouristServicesState extends State<TouristServices> {
  ...
  _setAmbassadorName() async
  {
    final prefs = await SharedPreferences.getInstance();

    final ambassadorName = prefs.getString('amb_name');

    if(ambassadorName != null)
      setState(() {
        ambName = ambassadorName;
      });
  }
            ...
            children: <Widget>[
              Container(
                ...
                padding: const EdgeInsets.only(
                    top: 40.0, right: 0.0, left: 0.0, bottom: 10.0),
                child: Card(
                  elevation: 2.0,
                  child: Row(
                    children: <Widget>[
                      Flexible(
                        child: Padding(
                          padding:
                              const EdgeInsetsDirectional.only(start: 10.0 , top: 15 , bottom: 15.0 , end: 10.0),
                          child: Text(
                            getTranslated(context, 'as_note'),
