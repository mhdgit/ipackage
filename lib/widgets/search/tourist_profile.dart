...
import 'package:ipackage/widgets/search/tourist_add_service.dart';

class TouristProfile extends StatefulWidget {
  @override
  _TouristProfileState createState() => _TouristProfileState();
}
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.of(context).push(new MaterialPageRoute(
                      builder: (BuildContext context) => new TouristAddService()));
                },
                child: Row(
                  children: <Widget>[
                    Expanded(
