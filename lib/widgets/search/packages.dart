...
class _PackagesState extends State<Packages> {
  ...
  void initState() {
    ...
    betaApi.getPackages().then((value) {
      setState(() {
        _rPackages = List.of(value);
                                  ...
                                  children: <Widget>[
                                    Padding(
                                      ...
                                      child: ClipPath(
                                        ...
                                        child: Image.network(
                                          'https://ipackagetours.com/storage/app/packages/' + _rPackages[index].image,
                                          fit: BoxFit.fill,
                                    ...
                                    Positioned.fill(
                                      ...
                                      child: Align(
                                        ...
                                        child: Text(
                                          localAssistant.getPackageByLocale(context, _rPackages[index]),
                                          style: TextStyle(
                                            fontSize: 15,
                                            color: Colors.white,
