...
class _SpecialOffersState extends State<SpecialOffers> {
  ...
  List<SpecialDomesticOffer> _specialDomesticOffers = [];
  ...
  void initState() {
    ...
    betaApiAssistant.getSpecialDomesticOffers().then((value) {
      setState(() {
        _specialDomesticOffers = List.of(value);
                ...
                onTap: () {
                  Navigator.of(context).push(new MaterialPageRoute(
                      builder: (BuildContext context) => new DomesticOfferMain(
                        id: _specialDomesticOffers[index].id,
                        package: localAssistant.getSpecialDomesticOfferByLocale(context, _specialDomesticOffers[index], 'package'),
                        rating: _specialDomesticOffers[index].rating.toString(),
                      ),
                  ));
                },
                child: Card(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: ClipPath(
                                ...
                                child: Image.network(
                                  'https://ipackagetours.com/storage/app/' + _specialDomesticOffers[index].image.toString(),
                                  fit: BoxFit.fill,
                              ...
                              child: Flex(
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    child: Text(
                                      localAssistant.getSpecialDomesticOfferByLocale(context, _specialDomesticOffers[index], 'package'),
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: Colors.black,
                                      ),
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                  padding: const EdgeInsets.only(
                                      ...
                                      bottom: 0.0),
                                  child: Text(
                                    _specialDomesticOffers[index].daysNumber.toString() +
                            ...
                            Expanded(
                              ...
                              child: FittedBox(
                                child: GFRating(
                                  ...
                                  value: double.parse(_specialDomesticOffers[index].rating.toString()),
                                ),
                              ),
                            ),
                          ],
                      ...
                      Padding(
                        ...
                        child: Text(
                          getTranslated(
                              ...
                              _specialDomesticOffers[index].startPrice.toString() + '\$',
                          textAlign: TextAlign.start,
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 15,
