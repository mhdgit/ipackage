...
class BookOfferMain extends StatefulWidget {
  final int id;
  final String package;
  final String rating;

  BookOfferMain({this.package,this.rating, this.id});

  @override
  _BookOfferMainState createState() => _BookOfferMainState();
}

class _BookOfferMainState extends State<BookOfferMain> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((value) {
      ...
      _loadUserPreferences().then((value) async {
        if (firstFlightDate == ' ')
          setState(() {
        ...
        books_api.get_books(token).then((value) {
          setState(() {
            print(value);
            //var offer_json = json.decode(value);
